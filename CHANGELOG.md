# [4.31.0-becode](https://github.com/math0r/BMAD-METHOD/compare/v4.30.4...v4.31.0) (2025-07-26)

### Major Features - BeCode Data Science Edition

- **TonyFunkman Data Science Agent**: Complete data science expert integrated into core BMAD
  - 13 specialized data science tasks covering BeCode curriculum to senior level
  - Data Engineering, Analysis, Machine Learning, MLOps, and GenAI capabilities
  - Integrated directly into bmad-core (no longer an expansion pack)

- **Enhanced Team Configurations**:
  - Added Scrum Master to data science teams for proper agile project management
  - Updated team-data-science and team-data-complete with SM integration
  - Improved workflow organization for data science projects

- **BeCode Workshop Support**:
  - Comprehensive BECODE-README.md with installation and usage instructions
  - Mac-specific installation instructions and troubleshooting
  - Platform-specific scripts (install-local.bat for Windows, install-local.sh for Mac)
  - Complete learning path from beginner to advanced data science

- **Core Integration Improvements**:
  - Moved all data science capabilities from expansion pack to core system
  - Removed obsolete bmad-data-science expansion pack
  - Added brownfield-data-checklist.md to core checklists
